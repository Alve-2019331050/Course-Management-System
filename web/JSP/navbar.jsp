    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="./AdminHome" style="font-family:'Noto Sans'">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="./RegisterTeacher" style="font-family:'Noto Sans'">Register Teacher</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="./RegisterStudent" style="font-family:'Noto Sans'">Register Student</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="./ManageCourse" style="font-family:'Noto Sans'">Manage Course</a>
                </li>
